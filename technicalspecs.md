...
The actual transfer of the securities, once available, will be handled by the transfer agents SEP-0008 server. Stellar SEP-0008 protocol defines the way an investor can request to transfer thier securities.  
[SEP-0008 Regulated Assets](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0008.md)

[Workflow Diagram](https://dev.blocktimefinancial.com/images/SEP-008Workflow.png)

[BTF Transfer Services SEP-0001 Server Implementation Guide](https://github.com/blocktimefinancial/docs/blob/main/sep-0001.md)
[BTF Transfer Services SEP-0006 Server Implementation Guide](https://github.com/blocktimefinancial/docs/blob/main/sep-0006.md)
[BTF Transfer Services SEP-0008 Server Implementation Guide](https://github.com/blocktimefinancial/docs/blob/main/sep-0008.md)
[BTF Transfer Services SEP-0010 Server Implementation Guide](https://github.com/blocktimefinancial/docs/blob/main/sep-0010.md)
[BTF Transfer Services SEP-0012 Server Implementation Guide](https://github.com/blocktimefinancial/docs/blob/main/sep-0012.md)
[BTF Transfer Services SEP-0024 Server Implementation Guide](https://github.com/blocktimefinancial/docs/blob/main/sep-0024.md)
[BTF Transfer Services SEP-0038 Server Implementation Guide](https://github.com/blocktimefinancial/docs/blob/main/sep-0038.md)

### Trading

Trading of the GiG token may take place in a number of different ways based on the token type issued. Trading may be facilitated on the Stellar DEX, Swapping Smart Contracts such as SoroSwap, and other dedicated platforms and contracts, depending on the transfer restrictions on the GiG token.
...
Banking Partner - $1,000 (Ongoing Monthly Fees)  
KYC/AML/ACRD Partner - $8,500 (Usage Fees) (KYC Fees for Investors $1.15-$12), (KYB Fees for Businesses $80-$200), (Accredited Audit Fees per Investor $50-$100)
